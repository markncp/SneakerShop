            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="addressdetail" class="col-md-4 col-form-label text-md-right">{{ __('Addressdetail') }}</label>

                            <div class="col-md-6">
                                <input id="addressdetail" type="text" class="form-control @error('addressdetail') is-invalid @enderror" name="addressdetail" value="{{ old('addressdetail') }}" required autocomplete="addressdetail" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="road" class="col-md-4 col-form-label text-md-right">{{ __('Road') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subdistrict" type="text" class="form-control @error('subdistrict') is-invalid @enderror" name="subdistrict" value="{{ old('subdistrict') }}" required autocomplete="subdistrict" autofocus>
